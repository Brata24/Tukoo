...
{#if initialLoading}
	<div class="fixed inset-0 bg-white dark:bg-neutral-900 z-50 flex items-center justify-center">
		<div class="text-center">
			<div class="animate-spin mx-auto h-16 w-16 text-blue-600 dark:text-blue-400 mb-4">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
					<circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
					<path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
				</svg>
			</div>
			<h3 class="text-xl font-semibold text-gray-900 dark:text-neutral-200">Loading Merchants</h3>
			<p class="mt-2 text-sm text-gray-500 dark:text-neutral-400">Please wait...</p>
		</div>
	</div>
{:else}
<div class="m-4">
							...
							<tr class="hover:bg-gray-50 dark:hover:bg-neutral-700">
								...
								<td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
									<div class="flex items-center justify-end gap-x-2">
										<a
											href="https://{merchant.slug}.tukoo.web.id"
											target="_blank"
											rel="noopener noreferrer"
											class="inline-flex items-center gap-x-1 text-blue-600 hover:text-blue-900 dark:text-blue-500 dark:hover:text-blue-400"
										>
											View
